export const technicalSkills = [
    { nombre: "Software Development", porcentaje: 75, icono: "fa-solid fa-laptop-code" },
    { nombre: "Web Development", porcentaje: 90, icono: "fa-solid fa-globe" },
    { nombre: "Scrum", porcentaje: 80, icono: "fa-solid fa-diagram-project" },
    { nombre: "DevOps", porcentaje: 60, icono: "fa-solid fa-infinity" },
    { nombre: "Git", porcentaje: 83, icono: "fa-brands fa-git-alt" },
];
